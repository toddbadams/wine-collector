...
{
    public class CreateRequestConverter : ITypeConverter<CreateRequest, CommandCollection>
    {
        public CommandCollection Convert(CreateRequest source, CommandCollection destination, ResolutionContext context)
        {
